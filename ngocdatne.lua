...
Notification.new("<Color=Yellow> Loading <Ngoc Dat Hub> <Color=/>"):Display()
...
local Window = OrionLib:MakeWindow({Name = "Ngoc Dat Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Ngoc Dat Hub"})
...
Notify("Welcome To Ngoc Dat Hub Release",5)
